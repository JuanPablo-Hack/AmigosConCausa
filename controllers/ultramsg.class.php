...
class WhatsAppApi
{
    ...
    public function __construct($token, $instance_id)
    {
        $this->token = $token;
        $this->instance_id =
            'instance' . preg_replace('/[^0-9]/', '', $instance_id);
    }
    ...
    public function sendVcardMessage(
        $to,
        $vcard,
        $priority = 10,
        $referenceId = ''
    ...
    {
        return $this->sendRequest('GET', 'instance/screenshot', [
            'encoding' => $encoding,
        ]);
    }
    ...
    public function sendInstanceSettings(
        $sendDelay = '1',
        $webhook_url = '',
        ...
        $params = [
            ...
            'webhook_message_received' => json_encode(
            ...
            'webhook_message_download_media' => json_encode(
    ...
    public function sendRequest($method, $path, $params = [])
    {
        ...
        if ($httpCode == 404) {
            return [
                'Error' =>
                    'instance not found or pending please check you instance id',
            ];
        }
